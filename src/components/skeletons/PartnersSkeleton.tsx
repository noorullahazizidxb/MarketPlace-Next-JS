    ...
    <section aria-hidden className="relative mt-12">
      <div className="container-padded">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="flex-1 h-px bg-[var(--border)]/40 rounded-full" />
        </div>
        {/* marquee shell */}
        <div className="relative overflow-hidden rounded-2xl border border-[var(--border)]/40 bg-[var(--card)]/60 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-8 px-8 py-6">
            {Array.from({ length: 7 }).map((_, i) => (
              <div
                key={i}
                className="shrink-0 flex items-center justify-center rounded-xl border border-[var(--border)]/40 bg-[var(--accent)]/10 w-36 h-20"
              >
