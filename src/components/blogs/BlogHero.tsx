        ...
        <div dir={isRtl ? "rtl" : "ltr"} className={`overflow-visible ${isRtl ? "text-right" : "text-left"}`}>
          ...
          >
            ...
            >
              ...
              {showSuggestions && (
                <div className="absolute left-0 right-0 top-[calc(100%+0.5rem)] z-30 rounded-2xl overflow-hidden border border-[var(--border)] bg-[var(--background)] shadow-token-lg backdrop-blur-sm">
