    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[var(--space-gap)] app-density-grid-gap">
      {listings.map((l, i) => (
        <motion.article
          ...
          className="group relative overflow-hidden rounded-[1.5rem] border border-border/[0.07] bg-card/90 backdrop-blur-xl shadow-token-lg hover:shadow-token-lg transition-shadow duration-300"
        >
          {/* Top shimmer line */}
