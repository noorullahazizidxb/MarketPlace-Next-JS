    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[var(--space-gap)] app-density-grid-gap">
      {listings.map((l, i) => (
        <motion.article
          ...
          className="group relative overflow-hidden rounded-[1.5rem] border border-white/[0.07] bg-card/90 backdrop-blur-xl shadow-[0_4px_24px_-8px_rgba(0,0,0,0.18)] hover:shadow-[0_12px_40px_-12px_rgba(0,0,0,0.28)] transition-shadow duration-300"
        >
          {/* Top shimmer line */}
          ...
          <div className="relative h-44 overflow-hidden">
            ...
            {/* category badge */}
            {l.category?.name && (
              <div className="absolute left-3 bottom-3 z-10 inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-black/40 backdrop-blur-sm px-2.5 py-1 app-text-caption font-semibold text-white/90">
