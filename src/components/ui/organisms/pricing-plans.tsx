...
import { Card, CardContent, CardHeader, CardTitle, CardFooter } from "../atoms/shadcn/card"
...
export function PricingPlans({
  ...
  const l = {
    currentPlan: labels.currentPlan ?? 'Current Plan',
    upgradePlan: labels.upgradePlan ?? 'Upgrade Plan',
    downgradePlan: labels.downgradePlan ?? 'Downgrade Plan',
  ...
  const getButtonText = (plan: PricingPlan) => {
    if (mode === 'billing') {
      ...
      if (planIndex > currentIndex) {
        return l.upgradePlan
      } else if (planIndex < currentIndex) {
        return l.downgradePlan
      }
    }
    return l.getStarted
  }
