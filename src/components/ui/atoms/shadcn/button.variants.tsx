...
export const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center whitespace-nowrap rounded-lg app-text-action transition-colors " +
  "app-text-action " +
  ...
  "disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      ...
      size: {
        default: 'min-h-[var(--ctrl-h-sm)] h-auto px-[var(--ctrl-px)] py-[var(--ctrl-py)]',
        sm: 'min-h-[var(--ctrl-h-sm)] h-auto px-3 rounded-md',
        lg: 'min-h-[var(--ctrl-h)] h-auto px-8 rounded-md',
        xl: 'min-h-[var(--ctrl-h)] h-auto px-8 rounded-lg app-text-body',
