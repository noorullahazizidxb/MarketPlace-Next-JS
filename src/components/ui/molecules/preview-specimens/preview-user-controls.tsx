  ...
  return (
    <div className="grid min-w-0 max-w-full gap-3">
      <div className="space-y-2">
        <label className="block app-text-label text-muted-foreground">Passenger email</label>
        <div
          data-slot="input"
        ...
        >
          <Search className="app-icon-sm text-muted-foreground" aria-hidden />
          <span className="app-text-body text-muted-foreground">agent@example.com</span>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-border/60 bg-background/80 p-3 shadow-sm">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-0.5 text-left">
            <p className="app-text-heading-sm text-foreground leading-snug">Booking access</p>
            <p className="app-text-micro leading-tight text-muted-foreground line-clamp-2">
        ...
        <Badge
          variant="outline"
          className="mt-2 w-fit rounded-full px-2 py-0.5 app-text-caption uppercase tracking-wide"
          style={{
