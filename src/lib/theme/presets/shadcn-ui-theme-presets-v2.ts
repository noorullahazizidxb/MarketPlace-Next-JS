...
export const shadcnThemePresetsBase: Record<string, ThemePreset> = {
  default: {
    label: "Default",
    styles: {
      light: {
  ...
  red: {
    ...
    styles: {
      ...
      dark: {
        ...
        "chart-3": "oklch(0.80 1 80)",
        "chart-4": "oklch(0.72 0.17 111)",
...
export const shadcnThemePresetsV2: Record<string, ThemePreset> =
  withPremiumBrandVariables(shadcnThemePresetsBase);