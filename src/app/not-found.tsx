...
export default function NotFound() {
  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden">
      ...
      >
        <div className="relative overflow-hidden rounded-3xl border border-[var(--border)] bg-[linear-gradient(to_bottom_right,var(--card),color-mix(in oklab, var(--card) 80%, transparent))] p-[var(--space-card)] sm:p-12 shadow-2xl">
          {/* Decorative sparkle */}
