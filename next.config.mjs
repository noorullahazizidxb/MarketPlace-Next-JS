...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      { protocol: 'http', hostname: 'localhost', port: '4002', pathname: '/**' },
      { protocol: 'http', hostname: '127.0.0.1', port: '4002', pathname: '/**' },
      ...
      { protocol: 'http', hostname: '180.222.140.40', port: '4002', pathname: '/**' },
